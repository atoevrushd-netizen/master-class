(function () {
  ...
  var I18N = {
    tg: {
      ...
      cta_label: "Ҷой банд кунед",
      cta_aria: "Ҷой банд кунед — дар WhatsApp кушода мешавад",
      cta_wa_message: "Салом! Мехоҳам барои мастер-класси 12–13 декабр ҷой банд кунам.",
      cta_hint: "Шумораи ҷойҳо маҳдуд аст",
      cta_hint_wa: "бақайдгирӣ тавассути WhatsApp",
      ...
      d1_quote: "«То вақте ки худатон тағйир наёбед, бизнесатон тағйир намеёбад»",
      ...
      d2_2_r: "Маҳсулот, мизоҷ ва арзиш: бизнеси шумо чӣ гуна даромад меорад",
      d2_3_t: "Системаи маркетинг",
      d2_3_r: "Мизоҷ аз куҷо меояд ва лидҳо чӣ гуна ҷалб мешаванд",
      d2_4_t: "Системаи фурӯш",
      d2_4_r: "Лид → мизоҷ → фармоиш → пардохт → такрор",
      d2_5_t: "Даста ва сохтори ташкилӣ",
      d2_5_r: "Кӣ чӣ кор мекунад ва соҳибкор чӣ гуна аз корҳои оперативӣ мебарояд",
      d2_6_t: "Системаи молиявӣ",
      d2_6_r: "Даромад → фоидаи умумӣ → фоидаи соф → ҷараёни пул → қарз",
      ...
      d2_quote: "«Мақсад ин нест, ки шумо бештар кор кунед. Мақсад ин аст, ки бизнес бе вобастагӣ аз шумо кор карда тавонад»",

      breaks_note: "Ҳар ду рӯз: хӯроки нисфирӯзӣ 14:00–15:00 ва танаффусҳои қаҳва",
      ...
      sticky_cta: "Ҷой банд кунед",
    },

    ru: {
      doc_title: "Мастер-класс — 12–13 декабря | Сайдахтам Атоев",
      meta_desc: "Двухдневный мастер-класс Сайдахтама Атоева, 12–13 декабря. День 1 — личность и лидерство, день 2 — построение бизнеса как системы.",
      ...
      hero_title: "Мастер-класс",
      hero_subtitle: "Первый день — вы меняетесь как личность и руководитель, второй — выстраиваете бизнес как систему.",
      month_dec: "декабря",
      ...
      d1_1_r: "Вы определите свою главную проблему",
      d1_2_t: "Личность: кто я?",
      d1_2_r: "Ваш текущий уровень: личность, решения, ответственность",
      d1_3_t: "Отец и мать — внутренняя программа человека",
      d1_3_r: "Как окружение в детстве влияет на деньги, решения, отношения и бизнес",
      d1_4_t: "Качества успешного лидера",
      d1_4_r: "Ответственность, дисциплина, принятие решений, смелость, контроль и стратегическое мышление",
      ...
      d1_6_r: "Вы определите свои три ключевых изменения",
      ...
      d2_1_r: "Закрепление результатов",
      d2_2_t: "Бизнес-модель",
      d2_2_r: "Продукт, клиент и ценность: как ваш бизнес зарабатывает",
      d2_3_t: "Система маркетинга",
      d2_3_r: "Откуда приходят клиенты и как привлекать лиды",
      d2_4_t: "Система продаж",
      d2_4_r: "Лид → клиент → заказ → оплата → повторная продажа",
      d2_5_t: "Команда и оргструктура",
      d2_5_r: "Кто за что отвечает и как владельцу выйти из операционного управления",
      d2_6_t: "Финансовая система",
      d2_6_r: "Выручка → валовая прибыль → чистая прибыль → денежный поток → долги",
      d2_7_t: "KPI и контроль",
      d2_7_r: "Ежедневное управление бизнесом по цифрам",
      d2_8_t: "Карта бизнеса от А до Я",
      d2_8_r: "Вы составите карту системы своего бизнеса",
      d2_quote: "«Цель не в том, чтобы вы работали больше. Цель в том, чтобы бизнес мог работать независимо от вас»",

      breaks_note: "Оба дня: обед 14:00–15:00 и кофе-брейки",
